...
class ICutThumb extends CInputWidget{
    ...
    private function _show()
    {
       ...
       $route = RESOURCE.DIRECTORY_SEPARATOR.$this->folder.$ext;
       $path = DIRECTORY_SEPARATOR.$route;
       ...
       $silde = Storage::model()->findByAttributes(array('app_id'=>$this->app_id,'res_id'=>$id));
        if(RESOURCE_PATH.DIRECTORY_SEPARATOR.$this->folder.$ext.$thumb)
        {
