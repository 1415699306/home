...
<div class='main'>
    	...
    	<div class='leftfloat leftfloat_bg'> 
            ...
            <div class='mainTop_leftM'>
                 ...
                 <?php foreach($ariticle as $key=>$val):?>
                     <?php if($key < 1):?>
                <div class='Headlines'>
                    <h1><?php echo CHtml::link(Helper::truncate_utf8(Chtml::encode($val['title']),12,false),$this->createUrl('/article/list/view',array('id'=>$val['id'])),array('title'=>$val['title'],'target'=>'_blank'));?></h1>
                ...
                <div class='mainTop_text'>
                      ...
                      <ul class='mainTop_list'>
                       <?php echo CHtml::link($val['title'],$this->createUrl('/article/list/view',array('id'=>$val['id'])),array('target'=>'_blank','img_url'=>Storage::getImageBySize($val['track_id'],'article','4_3','thumb')));?>
                        <li><b><?php echo CHtml::link(Helper::truncate_utf8(Chtml::encode($val['title']),10,false),$this->createUrl('/article/list/view',array('id'=>$val['id'])),array('title'=>$val['title'],'target'=>'_blank'));?></b></li>                 
                            <?php foreach(Article::getArticle(2,$key) as $v):?>
                                <li><?php echo CHtml::link(Helper::truncate_utf8(Chtml::encode($v['title']),10,false),$this->createUrl('/article/list/view',array('id'=>$v['id'])),array('target'=>'_blank'));?></li>                 
                            <?php endforeach;?> 
                    </ul>
                    <?php endif;?>
                  <?php endforeach;?> 
        	...
        	<ul class='rightAikanText_list'>
            	...
            	<li class='tall'>
                    <div class='bd' id="newhead">
                        ...
                        <?php echo CHtml::link(CHtml::encode(Helper::truncate_utf8($val['discription'],40)),$this->createUrl('/article/list/view',array('id'=>$val['id'])),array('discription'=>$val['discription'],'target'=>'_blank'));?>
               		</div>	
                </li>
                <?php else:?>
                <li>
    	...
    	<div class='center'>
            ...
            <div  class="bd" id="bd">
             <ul class="slideshow" id="demo">
             	...
             	<li class="li_2">
                   <div class='floatLeft'><?php echo CHtml::link($key['title'],$this->createUrl('/celebrity/list/view',array('id'=>$key['id'])),array('target'=>'_blank','img_url'=>Storage::getImageBySize($key['track_id'],'celebrity','4_3','thumb')));?></div>    
    ...
    <div class='rightdiv leftfloat_bg' style="height:278px;">
                ...
                <div class='meetingContent'>
					...
					<p class='last'>主题：<b>2013中国（广州）国际建筑装饰博览会</b></p>
		...
		<div class="carousel"> 
			<div class="slides">
					<?php foreach($interview as $key):?>
                        <div class="slideItem">   
                            <a href="<?php echo $key['link'];?>" img_url="<?php echo Storage::getImageBySize($key['track_id'],'news','9_16','thumb');?>" target="_blank"></a>
                        </div>
                    <?php endforeach;?>
			</div> 
            ...
            <div class='mainTCenter_Top'>
                ...
                <div class='mainTCenter_TopPic'>  
                    <a href="<?php echo $key['link'];?>" img_url="<?php echo Storage::getImageBySize($key['track_id'],'news','4_3','thumb');?>" target="_blank"></a>
                </div>
            ...
            <div class='mainTCenter_bottom'>
                	<ul class='mainTCenter_list'>
                     ...
                     <?php if($key < 2):?>
                        <li>
                            <a href="<?php echo $val['link'];?>" img_url="<?php echo Storage::getImageBySize($val['track_id'],'news','4_3','thumb');?>" target="_blank"></a>
                        </li>
                        <?php else:?>
                        <li style=' float:right; padding-right:0;'><a href="<?php echo $val['link'];?>" img_url="<?php echo Storage::getImageBySize($val['track_id'],'news','4_3','thumb');?>" target="_blank"></a></li>
                           <?php endif;?>
                        <?php endforeach;?> 
                    </ul>
                </div>
			...
			<div class="buttonNav">
                <?php foreach($gover as $key):?>
                    <div style="text-align: left;" class="bullet">
                        ...
                        <p> <span>项目责任主体：</span><?php echo CHtml::encode(Helper::truncate_utf8(!empty($key['contacts'])?$key['contacts']:'暂无数据',10,false));?></p>
  ...
  <div class='bigdiv'>
    	<div class='leftdiv'>
           ...
           <div class='Leftside_pic'>
               ...
               <?php foreach($beauty as $key=>$val):?>
            	...
            	<div class="piclist_position">   
                    <a href="<?php echo $val['link'];?>" img_url="<?php echo Storage::getImageBySize($key['track_id'],'news','9_16','thumb');?>" class="imgArea sytle adv_pic" target="_blank"></a>
                ...
                <div class='piclist_position_2'>
                     <a href="<?php echo $val['link'];?>" img_url="<?php echo Storage::getImageBySize($key['track_id'],'news','4_3','thumb');?>" class="imgArea sytle adv_pic" target="_blank"></a>
                     <div class="lazy_content"> 
                    <div class='pic_text'>
               ...
               <?php endif;?>
                ...
                <div class='Leftside_text'>
                   <ul class='textlist'>
                       ...
                       <li><?php echo CHtml::link(CHtml::encode(Helper::truncate_utf8($key['title'],20,false)),$this->createUrl('/life/list/view',array('id'=>$key['id'])),array('title'=>$key['title'],'target'=>'_blank'));?></li>   
                       <?php endforeach;?>
                   </ul>
               </div>
          </div>
         ...
         <div class='centerside_pic' id="bestShow">
          	<ul class='centerside_pic_list' >
            	...
            	<li class="piclist_1">
                    <span id="img_url" link_href="<?php echo $key['link'];?>" img_title="<?php echo $key['title']?>" img_url="<?php echo Storage::getImageBySize($key['track_id'],'news','4_3','thumb');?>" class='imgArea sytle adv_pic' target='_blank'></span>  
                    <div class="lazy_content"> 
         ...
         <div class='centerside_pic' id="con_bestId<?php echo $key['id'];?>" style="display:none; float:right;">  
          	<ul class='centerside_pic_list'> 
            	...
            	<li class="piclist_1">
                    <a href="<?php echo $v['link'];?>" img_url="<?php echo Storage::getImageBySize($v['track_id'],'news','4_3','thumb');?>" class="imgArea sytle adv_pic" target="_blank"></a>
                    <div class="lazy_content"> 
                        <div class='pic_text pic_text_1'>
                            <ul class='mainTitle mainTitle_3'>
                                <li><?php echo CHtml::encode(Helper::truncate_utf8($v['title'],10,false));?></li>
      ...
      <div class='rightdivContent'>
                    ...
                    <div class='rightpic_list'>
                     <span id="img_url" link_href="<?php echo $key['link'];?>" img_title="<?php echo $key['title']?>" img_url="<?php echo Storage::getImageBySize($key['track_id'],'news','4_3','thumb');?>"  target='_blank'></span>
                            <div class="lazy_content"> 
                                <div class='pic_text'>
