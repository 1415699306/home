...
<?php $this->pageTitle='商品_'.$model->title.'_乐荟网';?>
<?php 
...
$this->breadcrumbs=array(
    '商品'=>DIRECTORY_SEPARATOR.$this->module->id,
    $model->title,
);
?>
<div class="news_left">
	<div class="news_top">
    	<div class="title">
            ...
            <div class="new_content"><?php echo  BaseApp::pageByContent($model->shopContent->content,$model->shopContent->pages);?></div>
