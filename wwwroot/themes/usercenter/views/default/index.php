...
<div class='RightDiv'>
        	...
        	<div class='bigDiv'>
            	...
            	<div class='subButtom'>
                    <div class='subButtom_left'><a href="#"><?php echo CHtml::image(Yii::app()->theme->baseUrl.'/images/Personal_42.jpg');?></a></div>
                    <div class='subButtom_right'>
                ...
                <div class='content'>
                	...
                	<div class='listdiv'>
                        ...
                        <div class='list'>
                            ...
                            <div class='view-bar'>
                               <?php $this->widget('zii.widgets.jui.CJuiProgressBar', array('value'=>$discovery->targetItems,'htmlOptions'=>array('style'=>'height:8px;'),));?>
                            </div>
                            <div class='textList'>
                                <ul class='complete'>
