 ...
 */
class LifeContent extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('life_id, pages', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
            'life'=>array(self::BELONGS_TO,'Life','id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('life_id',$this->article_id);
