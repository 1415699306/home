 ...
 */
class StudyContent extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array(' study_id, pages', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, study_id, content', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
            'study'=>array(self::BELONGS_TO,'Study','id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('study_id',$this->article_id);
