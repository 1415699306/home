...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/api/upload/editor"             //图片上传提交地址
        ...
        //附件上传配置区
        ,fileUrl:"/api/upload/fileupload"               //附件上传提交地址
        ,filePath:"/"                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"/api/upload/getRemoteImage.php"   //处理远程图片抓取的地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:"/api/upload/imageManager"       //图片在线管理的处理地址
        ,imageManagerPath:"/"                                    //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: '127.0.0.1'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: URL +"/api/upload/imageUp.php" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        ,snapscreenPath: URL + "/"
        ...
        //word转存配置区
        ,wordImageUrl:URL + "/api/upload/imageUp.php"             //word转存提交地址
        ,wordImagePath:URL + "/"                       //
        //,wordImageFieldName:"upfile"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数


        //获取视频数据的地址
        ,getMovieUrl:URL+"/api/upload/getMovie.php"                   //视频数据获取地址
