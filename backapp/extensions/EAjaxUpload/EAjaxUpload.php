...
class EAjaxUpload extends CWidget
{
        ...
        public function run()
        {
            if(empty($this->config['action'])) throw new CException('EAjaxUpload: param "action" cannot be empty.');
            if(empty($this->config['allowedExtensions']))throw new CException('EAjaxUpload: param "allowedExtensions" cannot be empty.');
            if(empty($this->config['sizeLimit']))throw new CException('EAjaxUpload: param "sizeLimit" cannot be empty.');
            ...
            Yii::app()->clientScript->registerScriptFile($baseUrl . '/fileuploader.js', CClientScript::POS_END);
